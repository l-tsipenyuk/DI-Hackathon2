...
//         "answeropt1": "I feel that now the need to donate is more than ever.",
//         "answeropt2": "I believe in charity power but now feel that I could contribute more with other deeds.",
//         "tags": {
//             "opt1": ["donate"],
//             "opt2": ["other"],
//         }
...
// Answer for Example 
const userAnswers = ["make a tiny workout.", "adopting a cute dog.", "Music, yoga, zumba...I love outdoor activites and would love to share it!"];
const maxCategory = categorizeUser(userAnswers);
console.log("User's maximum category:", maxCategory);


// Answer for a full example (doesn't work yet)
